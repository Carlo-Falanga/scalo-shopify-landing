...
@section('content')
    <header class="sticky top-0 z-10 bg-ink">
        <div class="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
            <span class="text-lg font-bold tracking-tight text-white">Scalo</span>
            <a href="#richiesta"
    ...
    <section class="border-b border-stone-200 bg-white px-6 py-12">
        <div class="mx-auto max-w-5xl text-center">
            <p class="text-xs font-semibold uppercase tracking-widest text-stone-500">I brand che crescono con Scalo</p>
            <p
                class="mt-4 flex flex-wrap items-center justify-center gap-x-10 gap-y-3 text-xl font-semibold text-stone-800">
                <span>Forno Vernile</span>
                <span>Camiceria Sanfelice</span>
                <span>Filoverde</span>
                <span>Credito Lineare</span>
    ...
    <section class="border-t border-stone-200 bg-white px-6 py-24">
        <div class="mx-auto max-w-5xl">
            <h2 class="text-center font-display text-2xl font-bold uppercase sm:text-3xl">
                Perché affidare la migrazione a Scalo
            </h2>
            <div class="mt-12 grid gap-10 md:grid-cols-2">
                ...
                <div>
                    ...
                    <p class="mt-2 text-stone-600">
                        Dal food artigianale alla moda su misura, fino ai servizi finanziari: negozi con cataloghi, volumi
                        e integrazioni molto diversi tra loro.
                    </p>
                </div>

                <div>
                    <p class="text-xs font-semibold uppercase tracking-widest text-stone-500">Caso studio</p>
                    <h3 class="mt-2 text-lg font-bold">4.000 referenze su Shopify Plus</h3>
                    <p class="mt-2 text-stone-600">
                        Migrazione completa con redesign dell'esperienza utente per un e-commerce di apparecchiature
                        termoidrauliche, catalogo profondo e schede prodotto tecniche.
                    </p>
                </div>
