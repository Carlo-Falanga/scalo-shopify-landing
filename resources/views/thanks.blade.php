...
@section('title', 'Richiesta ricevuta - Scalo')

@section('content')
    <div class="flex min-h-screen flex-col bg-ink">
        <header>
            <div class="mx-auto max-w-5xl px-6 py-4">
                <a href="{{ route('landing') }}" class="text-lg font-bold tracking-tight text-white">Scalo</a>
            </div>
        </header>
        <main class="flex flex-1 items-center px-6 py-24 text-center">
            <div class="mx-auto max-w-2xl">
                ...
                <p class="mt-8 text-lg text-stone-300">
                    Un consulente Scalo guarda il tuo negozio e ti propone data e ora per la call di 30 minuti.
